...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/blog/BlogServlet" name="form1" enctype="multipart/form-data">
<table>
	<tr>
	...
	<tr>
		<td>一般會員編號:</td>
		<td><input type="TEXT" name="memberid" size="45" value="<%=blogVO.getMemberId()%>" /></td>
	</tr>
	<tr>
		<td>文章分類:</td>
		<td><input type="TEXT" name="blogclass" size="45" value="<%=blogVO.getBlogClass()%>" /></td>
	</tr>
	<tr><%=blogVO.getPostDate()%>
		<td>發文日期:</td>
		<td>
		  <input type="TEXT" name="xx" size="45"	value='<fmt:formatDate value="${blogVO.getPostDate()}" pattern="EEE, MMM d, ''yy"/>' readonly="readonly" style="background-color:lightgrey "/>
		  <input type="hidden" name="postdate" size="45"	value='${blogVO.getPostDate()}' />
		  </td>
	</tr>
	<tr>
		<td>標題:</td>
		<td><input type="TEXT" name="title" size="45"	value="<%=blogVO.getTitle()%>" /></td>
	</tr>
	<tr>
		<td>內文:</td>
		<td><input type="TEXT" name="text" size="45" value="<%=blogVO.getText()%>" /></td>
	</tr>
	<tr>
		<td>照片:</td>
