          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">${adminVO.membername}</span>
                <img class="img-profile rounded-circle" src="<%=request.getContextPath()%>/back-end/adm/admshow.do?adminid=${adminVO.adminid}">
              </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<%=request.getContextPath()%>/back-end/back-login.jsp">Logout</a>
        </div>
      </div>
    </div>
  </div>
