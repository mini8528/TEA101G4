				...
				<div class="card shadow-none bg-transparent">
					...
					<div class="card-body border border-top-0 rounded-bottom">
						<ul class="list-unstyled mb-0">
							<li class="mb-2">
								<a class="text-muted font-weight-medium d-block border rounded py-2 pl-3" href="blog-grid-left-sidebar.html">心得交流</a>
							</li>
							<li class="my-2">
								<a class="text-muted font-weight-medium d-block border rounded py-2 pl-3" href="blog-grid-left-sidebar.html">健康食譜</a>
							</li>
							<li class="my-2">
								<a class="text-muted font-weight-medium d-block border rounded py-2 pl-3" href="blog-grid-left-sidebar.html">健身影片</a>
							</li>
							<li class="my-2">
								<a class="text-muted font-weight-medium d-block border rounded py-2 pl-3" href="blog-grid-left-sidebar.html">文章收藏</a>
							</li>
							<li class="mt-2">
								<a class="text-muted font-weight-medium d-block border rounded py-2 pl-3" href="blog-grid-left-sidebar.html">發文</a>
							</li>
						</ul>
					</div>
				</div>
