...
===================================== -->
		<section class="py-8 py-md-10">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-lg-9 order-md-1">
							...
							<div class="position-relative">
								...
								<div class="card-img-overlay">
									<span class="badge badge-rounded badge-warning"><fmt:formatDate
										...
										<fmt:formatDate value="<%=blogVO.getPostDate()%>" pattern="d日" /></span>
								</div>
							</div>
										...
										<ul class="list-unstyled d-flex mb-6">
											...
											<li class=""><a class="text-muted d-inline-block mr-3"
												href="#user"><i class="fa fa-user mr-2"
													aria-hidden="true"></i>${memberVO.name}</a></li>
						...
						<div class="bg-light shadow-sm rounded px-3 pt-3 pb-6 mb-4">
							<h3 class="mb-4 text-danger font-weight-bold"><%=list.size() %> Comments</h3>
			 ...
			 <input type="submit" class="btn btn-danger text-uppercase" value="submit" style="background: #3E6B7E; border-color:#3E6B7E; ">
						...
						<div class="card shadow-none bg-transparent">
							...
							<div class="card-body border border-top-0 rounded-bottom">
								<ul class="list-unstyled mb-0">
									...
									<li class="mt-2"><a
										class="text-muted font-weight-medium d-block border rounded py-2 pl-3"
										href="blog-grid-left-sidebar.html">我的文章</a></li>
								</ul>
							</div>
						</div>
						<!-- 						<div class="mb-4"> -->
