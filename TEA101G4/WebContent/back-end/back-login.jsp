            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <!-- --------------------------到虛線為操作登入----------------------------- -->
                  <form action="<%=request.getContextPath()%>/AdminiLogin" method="POST" role="form">
                    
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="memberuser"
                      	value="${memberuser == null ? '' : memberuser}"  placeholder="User name"
                      	data-error="請輸入帳號" required="required">
                    </div>
                    
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="passwd"
                      	value="${passwd == null ? '' : passwd}"  placeholder="Passwd"
                      	data-error="請輸入密碼" required="required">
                      	</div>
