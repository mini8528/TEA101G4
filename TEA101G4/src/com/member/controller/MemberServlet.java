	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("update".equals(action)) { // 來自update_blog_input.jsp的請求
			...
			try {
				...
				MemberService mService = new MemberService();
				memberVO = mService.updateMember(memberid,name,account,password,gender,phone,birthday,email,photo,address,authority,qualifications,expertise,introduction,photo1,photo2,photo3,adddate);
		...
		if ("insert".equals(action)) { // 來自addEmp.jsp的請求
			...
			try {
				...
				/*************************** 2.開始新增資料 ***************************************/
				MemberService mService = new MemberService();
				memberVO = mService.addMember(name,account,password,gender,phone,birthday,email,photo,address,authority,qualifications,expertise,introduction,photo1,photo2,photo3,adddate);
